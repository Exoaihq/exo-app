    ...
    <form onSubmit={onSubmit} className="items-center">
      <div className="border-black/12.5 rounded-b-2xl border-t-0 border-solid p-6 block">
        <div className="flex">
          ...
          <button
            type="submit"
            className="inline-block px-6 py-3 mb-0 ml-2 font-bold text-center text-white uppercase align-middle transition-all border-0 rounded-lg cursor-pointer hover:scale-102 active:opacity-85 hover:shadow-soft-xs bg-gradient-to-tl from-primary-500 to-primary-200 leading-pro text-xs ease-soft-in tracking-tight-soft shadow-soft-md bg-150 bg-x-25"
          >
